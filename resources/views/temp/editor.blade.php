...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('lib/svg-edit-2.7/jgraduate/css/jPicker.css') }}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('lib/svg-edit-2.7/jgraduate/css/jgraduate.css') }}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('lib/svg-edit-2.7/svg-editor.css') }}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('lib/svg-edit-2.7/spinbtn/JQuerySpinBtn.css') }}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('temp/style.css') }}" type="text/css"/>

    <script src="{{ asset('lib/svg-edit-2.7/jquery.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/js-hotkeys/jquery.hotkeys.min.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/jquerybbq/jquery.bbq.min.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/svgicons/jquery.svgicons.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/jgraduate/jquery.jgraduate.min.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/spinbtn/JQuerySpinBtn.min.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/touch.js') }}"></script>

    <script src="{{ asset('lib/svg-edit-2.7/svgedit.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/jquery-svg.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/contextmenu/jquery.contextMenu.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/browser.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/svgtransformlist.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/math.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/units.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/svgutils.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/sanitize.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/history.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/coords.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/recalculate.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/select.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/draw.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/path.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/svgcanvas.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/svg-editor.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/locale/locale.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/contextmenu.js') }}"></script>
    ...
    <script src="{{ asset('lib/svg-edit-2.7/config.js') }}"></script>

    <!-- always minified scripts -->
    <script src="{{ asset('lib/svg-edit-2.7/jquery-ui/jquery-ui-1.8.17.custom.min.js') }}"></script>
    <script src="{{ asset('lib/svg-edit-2.7/jgraduate/jpicker.js') }}"></script>

    <script src="{{ asset('temp/script.js') }}"></script>
</head>
<body data-token="{{{ Session::token() }}}">
    ...
    <div id="fotolia_box">
        <input type="text" id="fotolia_input">
        <button id="fotolia_search_button">Search</button>
        Price: <span id="price">0</span> USD
        <button id="save_btn">Save</button>
        <div id="fotolia_search_result"></div>
    </div>
