...
//	}
	...
	if($(this.selectedElement).attr('id').indexOf("fotolia") === 0){
		selectedImage = $(this.selectedElement).attr('id').substr(7);
		$('#imagePriceRect').show();
		$('#imagePrice').show();
	}else{
		$('#imagePriceRect').hide();
	...
	countPrice();
	if ( $(this.selectedElement).attr('width')>0 && $(this.selectedElement).attr('height')>0 ) {
		//countPrice();
		console.log($(this.selectedElement).attr('width') + ' ' + $(this.selectedElement).attr('height'));
		console.log($(this.selectedElement).data('sizeRender') );
		//fix rendering bug
		if ( $(this.selectedElement).data('sizeRender') ) {
			var controlRender = $(this.selectedElement).data('sizeRender').toFixed(3);
			var existedRender = ($(this.selectedElement).attr('width') / $(this.selectedElement).attr('height')).toFixed(3);
			if ( controlRender > existedRender) {
				$(this.selectedElement).attr('height', $(this.selectedElement).attr('width')/$(this.selectedElement).data('sizeRender') );
				this.resize();
			} else if ( controlRender < existedRender) {
				$(this.selectedElement).attr('width', $(this.selectedElement).attr('height')*$(this.selectedElement).data('sizeRender') );
				this.resize();
			}			
		}
		//
