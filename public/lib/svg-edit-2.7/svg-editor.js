			...
			*/
			...
			var deleteSelected = function() {
				if (selectedElement != null || multiselected) {
					delete imageMedia[selectedElement.getAttribute("id").substr(7)];
					countPrice();
...
//			});
			...
			editor.ready(function() {
				$.ajax({
					...
					success: function(str) {
						...
						successLoad();
						console.log('template loaded'); //console.log(str);			
					},
		...
		editor.importImageFromUrl = function(file, imageId) {
